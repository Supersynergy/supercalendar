...
export type SingleCalendarProps = React.ComponentProps<typeof DayPicker>;

function SingleCalendar({ className, classNames, showOutsideDays = true, ...props }: SingleCalendarProps) {
  return (
    <DayPicker
